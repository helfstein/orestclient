...
namespace ORest.Extensions {
    static class DictionaryExtensions {
        ...
        private static object ConvertSingle(Type type, ITypeCache typeCache, object itemValue) {
            ...
            return
                //type == typeof(ODataEntryAnnotations)
                //? itemValue
                //: 
        ...
        private static object ConvertCollection(Type type, ITypeCache typeCache, object itemValue) {
            ...
            var count = ((itemValue as System.Collections.IEnumerable) ?? throw new InvalidOperationException()).Cast<object>().Count();
